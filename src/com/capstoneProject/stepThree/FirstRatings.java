...
public class FirstRatings {
    ...
    private ArrayList<EfficientRater> ratersList;
    private ArrayList<Movie> movieInformation;
    private HashMap<String, EfficientRater> ratersAndRatings;
...
//                .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    ...
    public ArrayList<EfficientRater> loadRaters(String fileName) throws IOException {
        Iterable<CSVRecord> records = readCsv("src/com/capstoneProject/data/"+fileName);
        for (CSVRecord record : records) {
            ...
            if(ratersAndRatings.containsKey(rater_id)){
                EfficientRater rater = ratersAndRatings.get(rater_id);
        ...
        for(EfficientRater rater : ratersAndRatings.values()){
    ...
    private void ratingsByRater(String rater_id){
        for(EfficientRater rater : ratersList){
...
//        }
    ...
    public void testLoadRaters(String file_name) throws IOException {
        ArrayList<EfficientRater> response = loadRaters("src/com/capstoneProject/data/"+file_name);
